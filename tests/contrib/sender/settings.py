...
WEBIX_SENDER = {
    "send_methods": [
        {
            ...
            "show_in_list": True,
            "show_in_chat": False,
            "config": {"from_email": "info@mpasol.it"},
        },
        {
            "method": "skebby",
        ...
        },
        {
            ...
            "show_in_list": False,
            "show_in_chat": True,
            "config": {"bot_token": "token", "webhooks": [], "commands": [], "handlers": []},
        },
        {
            "method": "storage",
    ...
    "recipients": [
        {"model": "dwsender.Customer", "datatable_fields": ["user", "name", "sms", "email", "telegram"]},
        {
