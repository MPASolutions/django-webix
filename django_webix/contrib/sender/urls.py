...
from django_webix.contrib.sender.views import (
    ...
    SenderListView,
    SenderMessagesChatView,
    SenderMessagesListView,
    SenderSendView,
    SenderTelegramWebhookView,
    SenderWindowView,
)
...
urlpatterns = [
    ...
    path(
        "messages_list/typology/<int:typology_pk>",
        SenderMessagesListView.as_view(),
        name="dwsender.messages_list.typology",
    ),
    path(
        "messages_list/typologiesgroup/<int:typologiesgroup_pk>",
        SenderMessagesListView.as_view(),
