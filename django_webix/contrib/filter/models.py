...
class WebixFilter(DALModel):
    ...
    insert_user = models.ForeignKey(
        settings.AUTH_USER_MODEL, verbose_name=_("Insert user"), blank=True, null=True, on_delete=models.CASCADE
    )
    ...
    assignees_groups = models.ManyToManyField(
        "auth.Group",
        blank=True,
