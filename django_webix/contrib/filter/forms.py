...
class WebixFilterForm(WebixModelForm):
                        ...
                        "cols": [
                            {
                                "view": "scrollview",
                                "scroll": "native-y",
                                "body": {"id": "querybuilder-container", "rows": []},
                            }
                        ],
                        "paddingY": 20,
                    },
    ...
    def clean(self):
        ...
        if (
            "visibility" in cleaned_data
            and cleaned_data["visibility"] != "restricted"
            and "assignees_groups" in cleaned_data
            and hasattr(cleaned_data["assignees_groups"], "none")
            and callable(getattr(cleaned_data["assignees_groups"], "none"))
        ):
