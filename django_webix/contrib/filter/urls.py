...
from django_webix.contrib.filter.views import (
    DjangoWebixFilterView,
    FilterConfigView,
    FilterSuggestExact,
    WebixFilterCreate,
    WebixFilterDelete,
...
urlpatterns = [
    ...
    path("<str:app_label>/<str:model_name>/config", FilterConfigView.as_view(), name="dwfilter.filter_config"),
    ...
    path(
        "webixfilter/list/<str:app_label>/<str:model_name>",
        WebixFilterList.as_view(),
