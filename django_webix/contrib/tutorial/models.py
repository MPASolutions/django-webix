...
class TutorialItem(Model):
    ...
    tutorial_type = models.CharField(
        _("Tutorial type"), max_length=32, choices=[("pdf", _("PDF")), ("video", _("Video"))]
    )
    target = models.CharField(
        _("Type of opening file"),
        max_length=32,
        choices=(("iframe", _("Modal with iframe")), ("_self", _("Same window")), ("_blank", _("New tab"))),
        default="_self",
    )
    area = models.ForeignKey(TutorialArea, verbose_name=_("Area"), blank=True, null=True, on_delete=models.CASCADE)
