        ...
        _fields = [
            ...
            },
            {
                ...
                "datalist_column": format_lazy(
                    ...
                    fillspace: true,
                    sort: "server",
                    format:function(value){{if(value != ''){{
                    valuearr = value.split("T")[0].split('-'); valuearr2 = value.split("T")[1].split(':');
                    value=valuearr[2]+'/'+valuearr[1]+'/'+valuearr[0]+' '+valuearr2[0]+':'+valuearr2[1];
            ...
            },
            {
                ...
                "datalist_column": format_lazy(
                    ...
                    width: 70,
                    template: '<i style="cursor:pointer" class="webix_icon far fa-play"></i>',
