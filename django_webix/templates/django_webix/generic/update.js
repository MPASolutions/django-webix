...
{% block context_cleaner %}
    ...
    {% if failure_update_related_objects %}
        {% block failure_related_objects %}
        {% include "django_webix/include/list_failure_related_objects.js" with failure_related_objects=failure_update_related_objects %}
        {% endblock %}
    {% else %}
        {% block form_standard %}
